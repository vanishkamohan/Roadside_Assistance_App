...
/****************************************************************************/
	...
	{		
        $http.post('http://10.0.2.2/projects/onroad/web/user_login.php', 
...
/************************** Cookies **********************************/	
	...
	{		
		$http.post('http://10.0.2.2/projects/onroad/web/worker_register.php',{
...
/****************************************************************************/
	...
	{		
        $http.post('http://10.0.2.2/projects/onroad/web/worker_login.php', 
			{'email': $scope.email, 'password':$scope.password})
		.success(function(data, status, headers, config) 
		{
			if(data.success == 1)
...
//************************** admin_register **********************************/	
	...
	{		
		$http.post('http://10.0.2.2/projects/onroad/web/user_register.php',{
		 'name':$scope.name,'email':$scope.email,'password':$scope.password, 
		 'mobile': $scope.mobile,'field_1': $scope.field_1,'field_2': $scope.field_2, 
...
/****************************************************************************/
	...
	{		
        $http.post('http://10.0.2.2/projects/onroad/web/admin_login.php', 
			{'email': $scope.email, 'password':$scope.password})
		.success(function(data, status, headers, config) 
		{
			if(data.success == 1)
...
//************************** admin_register **********************************/	
	...
	{		
		$http.post('http://10.0.2.2/projects/onroad/web/admin_register.php',{
...
/************************** Update Admin Info **********************************/
		...
		$http.post('http://10.0.2.2/projects/onroad/web/get_admin_info.php')
		.success(function(data, status, headers, config) 
		{
			if(data.success == 1)
			{			
...
/****************************************************************************/
	...
	{		
		$http.post('http://10.0.2.2/projects/onroad/web/admin_update.php',{
		 'name':$scope.name,'email':$scope.email,
		 'password':$scope.password,'mobile': $scope.mobile})
		.success(function(data, status, headers, config) 
		{
...
/****************************************************************************/
	...
	{		
        $http.post('http://10.0.2.2/projects/onroad/web/newpassword.php', 
			{	'email': $scope.email, 'password':$scope.password,
				'field_3': $scope.field_3, 'field_4':$scope.field_4
				})
		.success(function(data, status, headers, config) 
