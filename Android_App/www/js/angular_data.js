...
$scope.update_id = function(cus_id) 
	...
	{		
        ...
        $http.post('http://10.0.2.2/projects/onroad/web/update_location.php', 
			{	
	...
	$http.post('http://10.0.2.2/projects/onroad/web/get_business_all.php')
	.success(function(data, status, headers, config) 
	{
	...
	$http.post('http://10.0.2.2/projects/onroad/web/get_survey_choice_user.php')
		.success(function(data, status, headers, config) 
		{
			$scope.user_survey_choice_details = data.details;
        });
		
	$http.post('http://10.0.2.2/projects/onroad/web/get_bus_more.php', {'id': $scope.cook_bus_id})
	.success(function(data, status, headers, config) 
	{
			$scope.more_details = data.details;
    });
	
	$http.post('http://10.0.2.2/projects/onroad/web/get_user_rating.php', {'email': $scope.cook_user_email})
	.success(function(data, status, headers, config) 
	{
			$scope.user_rating_details = data.details;
    });
	
	$http.post('http://10.0.2.2/projects/onroad/web/get_bus_rating.php', {'email': $scope.cook_cus_id})
	.success(function(data, status, headers, config) 
	{
...
/****************************************************************************/
	...
	{		
		$http.post('http://10.0.2.2/projects/onroad/web/create_business.php', {
...
/************************** admin Details *********************************/
/****************************************************************************/
	$http.post('http://10.0.2.2/projects/onroad/web/admin_get.php')
	.success(function(data, status, headers, config) 
	{
		if(data.success == 1)
		{
...
/************************** Get Feedback *********************************/
/****************************************************************************/
	$http.post('http://10.0.2.2/projects/onroad/web/feedback_get.php', {	'email':$scope.cook_work_email})
	.success(function(data, status, headers, config) 
	{
		if(data.success == 1)
		{
...
/************************** Get All details  *********************************/
/****************************************************************************/
	$http.post('http://10.0.2.2/projects/onroad/web/get_business_user.php')
	.success(function(data, status, headers, config) 
	{
		if(data.success == 1)
		{
	...
	$http.post('http://10.0.2.2/projects/onroad/web/get_business.php', {'email':$scope.cook_work_email})
	.success(function(data, status, headers, config) 
	{
		if(data.success == 1)
		{
	...
	$http.post('http://10.0.2.2/projects/onroad/web/get_sport.php')
	.success(function(data, status, headers, config) 
	{
		if(data.success == 1)
		{
...
/****************************************************************************/
	...
	{		
		$http.post('http://10.0.2.2/projects/onroad/web/create_feedback.php', 
		{
...
/****************************************************************************/
		...
		$http.post('http://10.0.2.2/projects/onroad/web/get_user_info.php',
		{
...
$scope.user_update_info = function(name,password,mobile) 
	...
	{		
		$http.post('http://10.0.2.2/projects/onroad/web/user_update_info.php',{
...
/****************************************************************************/
	...
	{		
        $http.post('http://10.0.2.2/projects/onroad/web/delete_bus.php', 
		{
		'id': cus_id
		})
		.success(function(data, status, headers, config) 
...
$scope.update_business = function(cus_id,field_1,field_2,field_3,
	...
	{		
		$http.post('http://10.0.2.2/projects/onroad/web/save_business.php',{
...
/************************** Get All details  *********************************/
/****************************************************************************/
	$http.post('http://10.0.2.2/projects/onroad/web/work_get.php')
	.success(function(data, status, headers, config) 
	{
		if(data.success == 1)
		{
...
$scope.submit_survey = function() 
	...
	{		
        $http.post('http://10.0.2.2/projects/onroad/web/create_choice_user.php', 
		{
...
/****************************************************************************/
	$http.post('http://10.0.2.2/projects/onroad/web/user_get_all.php')
	.success(function(data, status, headers, config) 
	{
		if(data.success == 1)
		{
...
$scope.share_location = function(email) 
	...
	{		
        ...
        $http.post('http://10.0.2.2/projects/onroad/web/update_location_2.php', 
			{	
			'field_1': $scope.field_1, 'field_2':$scope.field_2,
	...
	$http.post('http://10.0.2.2/projects/onroad/web/get_user_request.php')
	.success(function(data, status, headers, config) 
	{
...
$scope.update_status_2 = function(cus_id,field_5) 
	...
	{		
		$http.post('http://10.0.2.2/projects/onroad/web/con_update_status_2.php',{
