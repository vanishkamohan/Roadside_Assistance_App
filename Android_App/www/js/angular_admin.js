...
/****************************************************************************/
	...
	{		
		$http.post('http://10.0.2.2/projects/onroad/web/complaint_status.php', {
...
/****************************************************************************/
	...
	$http.post('http://10.0.2.2/projects/onroad/web/complaint_get_all.php')
	.success(function(data, status, headers, config) 
	{
		if(data.success == 1)
		{
...
/****************************************************************************/
	...
	{		
		$http.post('http://10.0.2.2/projects/onroad/web/create_order.php', {
...
/****************************************************************************/
	...
	{		
		$http.post('http://10.0.2.2/projects/onroad/web/order_solution.php', {
...
/************************** View All Requirment *****************************/
/****************************************************************************/
	$http.post('http://10.0.2.2/projects/onroad/web/requirment_get_all.php')
	.success(function(data, status, headers, config) 
	{
		if(data.success == 1)
		{
...
/****************************************************************************/
	...
	{		
		$http.post('http://10.0.2.2/projects/onroad/web/admin_complaint_solution.php', {
...
/************************** View All Requirment *****************************/
/****************************************************************************/
	$http.post('http://10.0.2.2/projects/onroad/web/customer_get.php')
	.success(function(data, status, headers, config) 
	{
		if(data.success == 1)
		{
...
/****************************************************************************/
	...
	{		
        $http.post('http://10.0.2.2/projects/onroad/web/sales_delete.php', 
		{
...
/****************************************************************************/
	...
	{		
		...
		$http.post('http://10.0.2.2/projects/onroad/web/invoice_create.php', {
...
/****************************************************************************/
	...
	{
	$http.post('http://10.0.2.2/projects/onroad/web/products_update.php', {
...
/****************************************************************************/
	...
	$http.post('http://10.0.2.2/projects/onroad/web/products_get.php',{'status':$scope.status})
		.success(function (data, status, headers, config) 
		{
			if(data.success == 1)
			{
...
/****************************************************************************/
	...
	{
	$http.post('http://10.0.2.2/projects/onroad/web/products_add.php', {
...
/****************************************************************************/
	...
	{		
        $http.post('http://10.0.2.2/projects/onroad/web/products_delete.php', 
		{
...
/****************************************************************************/
	...
	{		
		$http.post('http://10.0.2.2/projects/onroad/web/sales_create.php', 
		{'fname': $scope.fname, 'lname':$scope.lname, 'email':$scope.email,
		'password': $scope.password,'plotno': $scope.plotno,
...
/****************************************************************************/
	...
	{
	$http.post('http://10.0.2.2/projects/onroad/web/sales_update.php', {
...
/****************************************************************************/
	...
	{		
        $http.post('http://10.0.2.2/projects/onroad/web/sms_send.php', 
		{
		'password': password
		})
		.success(function(data, status, headers, config) 
...
$scope.update_status_con = function(cus_id,field_9) 
	...
	{		
		$http.post('http://10.0.2.2/projects/onroad/web/con_update_status.php',{
